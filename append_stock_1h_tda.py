...
def tda_append_1h(ticker, filename):
    r = c.get_price_history(ticker,
                            ...
                            , start_datetime=datetime.datetime.strptime('2021-11-12', '%Y-%m-%d'), end_datetime=datetime.datetime.strptime('2021-12-15', '%Y-%m-%d'))
...
directory = rf'\\TOWER\financial data\1h Data Stocks'
